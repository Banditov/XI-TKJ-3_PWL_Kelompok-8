...
<!-- Post Detail -->
            <div class="w-full rounded-4xl bg-white text-[#545F71] drop-shadow-lg post">
                ...
                <div class="md:p-10 p-7 flex flex-col md:gap-7 gap-5">
                    <p class="text-2xl md:text-xl text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc dignissim malesuada ullamcorper. Phasellus lobortis augue quis consectetur lacinia. Suspendisse sed dolor quis nibh dictum hendrerit. Donec ac dolor consequat, egestas ligula eget, fringilla leo. Phasellus viverra libero id accumsan rhoncus.</p>
                    <div class="text-lg">
                        <div class="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="100 100 700 700" fill="#545F71" stroke="#545F71" class="w-6 h-6">
                                <path stroke-width="8" d="M517.5 205.6c-41 3.7-54.3 12-110.1 69-77.5 79.2-135.3 139-139.7 144.5-52.6 65.2-48.8 159.8 8.8 221.6s152.6 71.4 221.5 22.6c9.1-6.5 174.1-168.8 180.9-178 11-14.9-8.2-36.3-24.9-27.8-1.9.9-41.5 39.6-88 86-71.1 70.8-85.9 85.1-93 89.7-88.2 57.5-203-3.7-203-108.2 0-37.6 11.8-65 41-95.4 63.6-66.3 163-167.2 168.1-170.7 72.5-49.2 161 37.2 113 110.3-7.8 11.9-170.2 178.2-178.2 182.5-20.1 10.8-43.9-3.6-43.9-26.6 0-14.3-5-8.5 90.5-104.1 60-60 85.9-86.6 87-89.2 6.4-15.6-11.4-31.9-26.5-24.3-4 1.9-168.8 166-175.6 174.7-50.3 64.6 36.1 148.6 98.8 96.1 10-8.4 170.9-174.4 177.1-182.8 59.5-80-5.4-198.6-103.8-189.9z"/>
                            </svg>
