        ...
        <form action="/posts" method="POST" class="flex flex-col gap-5">
            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="flex flex-wrap gap-3 items-center">
                    <input type="text" name="tag" placeholder="New Tag" class="p-4 flex-1 min-w-[200px] text-gray-700 rounded-full border border-gray-500">
                    <div class="flex items-center gap-2">
                        <input type="text" name="tag" placeholder="Warna Atas" class="p-4 w-36 text-gray-700 rounded-full border border-gray-500">
                        <div class="h-14 w-14 shrink-0 border border-gray-500 rounded-xl flex items-center justify-center">
                            <div class="bg-red-500 w-12 h-12 rounded-xl"></div>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
                        <input type="text" name="tag" placeholder="Warna Bawah" class="p-4 w-36 text-gray-700 rounded-full border border-gray-500">
                        <div class="h-14 w-14 shrink-0 border border-gray-500 rounded-xl flex items-center justify-center">
                            <div class="bg-red-500 w-12 h-12 rounded-xl"></div>
                        </div>
                    </div>
            ...
            <textarea id="mytextarea">Enter your idea here!</textarea>
            <div class="flex flex-col gap-2">
                <div class="flex items-center gap-2">
                    <?= essIcon('linked', 'w-6 h-6') ?>
                    <p class="text-2xl font-bold">Links</p>
                </div>
                <ul class="list-disc ml-5">
                    <li>Add +</li>
                </ul>
            </div>
            <button type="submit" class="px-6 py-3 bg-[#2C7CFF] text-white rounded-full w-full">Submit</button>
        </form>
    </div>
</main>
