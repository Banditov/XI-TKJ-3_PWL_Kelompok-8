...
<main class="w-full h-screen flex">
    <div id="decorBox" class="p-10 hidden md:flex w-[60%] h-full justify-center items-center">
        <div id="decor"
            class="**:text-center **:drop-shadow-lg p-4 w-full h-[70%] text-white rounded-3xl bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10 border border-gray-100 flex flex-col items-center justify-between">
    ...
    <div
        class="bg-white w-full md:w-[40%] h-full p-10 drop-shadow-lg flex flex-col items-center justify-between **:text-[#545F71]">
        <div id="form" class="flex flex-col items-center justify-between h-[70%]">
            ...
            <form class="flex flex-col items-center w-full gap-5" action="/login" method="POST">
                <div class="flex flex-col w-full">
                    ...
                    <input id="email" name="email" type="email" class="rounded border p-2"
