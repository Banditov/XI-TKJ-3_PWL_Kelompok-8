...
<div id="loadingScreen" style="transition: opacity 0.5s ease-out;"
    ...
    <div class="flex flex-col items-center gap-8">
        <div class="relative w-20 h-20">
            <div class="absolute inset-0 rounded-full border-4 border-transparent border-t-[#FFCD56]"
                style="animation: spin 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;"></div>
            <div class="absolute inset-0 rounded-full border-4 border-transparent border-r-[#1D7BC5]"
                style="animation: spin 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite; animation-delay: -0.3s;"></div>
            <div class="absolute inset-0 rounded-full border-4 border-transparent border-l-[#FF4040]"
                style="animation: spin 1.2s cubic-bezier(0.5, 0, 0.5, 1) infinite;"></div>
        </div>
