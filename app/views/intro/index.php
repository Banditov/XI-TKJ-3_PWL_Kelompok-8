...
<div class="bg-[#1865a0] z-9998 overflow-hidden w-screen h-screen flex items-center justify-center"
    onclick="window.location.href='<?= $redirect ?>'">
    <div id="introContainer"
        class="intro-container bg-white flex items-center justify-center w-200 h-150 rounded-4xl shadow-lg relative">
        <div class="splash-container fixed inset-0 z-9999 flex items-center justify-center overflow-hidden ">
            ...
            <canvas id="ballsCanvas"
                class="balls-canvas absolute top-0 left-0 w-full h-full z-20 pointer-none:"></canvas>
        </div>
    </div>
</div>